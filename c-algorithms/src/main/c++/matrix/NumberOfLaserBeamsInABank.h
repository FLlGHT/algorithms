...
#ifndef C_ALGORITMS_NUMBEROFLASERBEAMSINABANK_H
#define C_ALGORITMS_NUMBEROFLASERBEAMSINABANK_H
...
public:
    int numberOfBeams(vector<string>& bank) {
        int numberOfBeams = 0, prevRowDevices = 0;

        for (string row : bank) {
            int currentRowDevices = count(row);
            if (currentRowDevices > 0) {
                numberOfBeams += prevRowDevices * currentRowDevices;
...
#endif //C_ALGORITMS_NUMBEROFLASERBEAMSINABANK_H
