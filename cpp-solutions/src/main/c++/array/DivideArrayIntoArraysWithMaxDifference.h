//
// Created by Michael Fedorenko on 17.12.2023.
//

#ifndef CPP_ALGO_DIVIDEARRAYINTOARRAYSWITHMAXDIFFERENCE_H
#define CPP_ALGO_DIVIDEARRAYINTOARRAYSWITHMAXDIFFERENCE_H
...
public:
    vector<vector<int>> divideArray(vector<int> &nums, int k) {
        ...
        for (int index = 1; index < nums.size(); index = index + 3) {
...
#endif //CPP_ALGO_DIVIDEARRAYINTOARRAYSWITHMAXDIFFERENCE_H
